...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen relative flex justify-center items-center my-20">
      <div className="absolute top-[40%] left-[50%] translate-x-[-50%] translate-y-[-50%] md:w-[90%] shadow-lg flex justify-between px-6 rounded-lg">
        <div className="lg:flex hidden ms-10 justify-center w-[50%]">
          <img
            src="https://ik.imagekit.io/fqy6m4jmj/weimages/Secure_login-bro.svg?updatedAt=1687173591904"
            alt="content-creator"
            width="600px"
          />
        </div>
        <Card color="transparent" shadow={false} className="p-3">
          ...
          >
            ...
            <Button
              className="mt-4 border hover:border-primaryPurple text-white font-bold hover:bg-white hover:text-primaryPurple"
              color="deep-purple"
              fullWidth
              type="submit"
            >
